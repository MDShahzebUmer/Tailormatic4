        ...
        <div class="col-md-12">
            <div class="panel panel-bordered">
                <div class="panel-body">
                    ...
                    <?php   $attstycode = App\Http\helpers::alltebinfo('attribute_styles',$description['ostyle'],'style_code'); ?>
                    <div class="col-sm-8">
                        ...
                        <div class="st-content-box full-width">
                            <div class="st-box-left">
                                <ul class="st-mf-list">
                                    ...
                                    <li class="st-mf-item"><label>Monogram</label><span>{{$description['omonogramName']}} @if($description['omonogramName']!='No Monogram'), Color : {{$description['omonogramCode']}}@endif</span>
                                    </li> 
                                </ul>
                            </div>
