    ...
    <td style="width:100%">
      <table style="background-color: #f1f1f1; font-size:14px; width:100%">
        ...
        <tr>
          ...
          <td style="vertical-align:middle;padding:5px;">{{$description['opacketName']}} @if($description['obreastPacket']=='true')with Breast Pocket @endif</td>
        </tr>
        <tr>
...
<table class="table" style="width:100%;background-color: #f1f1f1; margin-top:5px">
  ...
  <tr>
    <td colspan="2" style="background-color:#FFF;text-align:left; padding-top:5px; padding-left:5px;"><b>Type Measurement {{$description['osizePattern']}} , {{$description['osizeStyle']}} @if($description['osizePattern']=='Standard'), Size SML : {{$description['osizeFit']}} , Fit : Regular @endif ( {{$description['osizeType']}} )</b>
    </td>
  </tr>
  <tr> 
    <td colspan="2">
