...
<!-- ================================================ vest info ======================================== -->
<?php
$vest_ocontlapel = App\Http\helpers::optionval($description['vest_ocontlapel']);
$vest_ocontpockets = App\Http\helpers::optionval($description['vest_ocontpockets']);
?>
<table class="table" width="100%">
  <tr>
    <td  style="background-color: #efefef;">
      <table>
        ...
        <tr>
          <td width="50%"  style="background-color: #efefef;">
            <img src="<?=URL::asset('/storage/'.$description['vest_frntviewfinal'])?>" width="200px"> 
          </td>
          <td width="50%" style="background-color: #efefef;">
            <img src="<?=URL::asset('/storage/'.$description['vest_bkviewfinal'])?>" width="200px"> 
          </td>
        </tr>
      </table>
    </td>
    <td style="width:100%">
      <table style="background-color: #f1f1f1; font-size:14px; width:100%">
        <tr>
          <td style="vertical-align:middle;padding:5px;" width="30%">Fabric :</td>
          <td style="vertical-align:middle;padding:5px;" width="70%"><?=$description['vest_ofabricName']?> <img src="<?=URL::asset('/storage/'.$description['vest_ofabricImage'])?>" width=" 30px"></td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;" >Lapel :</td>
          <td style="vertical-align:middle;padding:5px;" ><?=$description['vest_opacketName']?></td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;" >Pockets:</td>
         <td style="vertical-align:middle;padding:5px;"><?=$description['vest_opacketName']?> </td>
        ...
        <tr>
          ...
          <td style="vertical-align:middle;padding:5px;"><?=$description['vest_obottomName']?> </td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Back :</td>
          <td style="vertical-align:middle;padding:5px;"><?=$description['vest_obackName']?> </td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Buttons:</td>
         <td style="vertical-align:middle;padding:5px;"><?=$description['vest_obuttonstyleName']?> </td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Button Color</td>
        <td style="vertical-align:middle;padding:5px;"><?=$description['vest_obuttonCode']?> ( <?=$description['vest_obuttonName']?> )</td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Thread Color</td>
         <td style="vertical-align:middle;padding:5px;"><?=$description['vest_obuttonHoleCode']?> (<?=$description['vest_obuttonHoleName']?>)</td>
        </tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Lining</td>
         <td style="vertical-align:middle;padding:5px;"><?=$description['vest_oliningName']?></td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td width="40%">
      <table style="font-size:14px; width:100%">
        <tr>
          ...
          <td colspan="3" style="vertical-align:middle;padding:5px;"><?=$description['vest_ocontrastName']?> <img src="<?=URL::asset('/storage/'.$sss = App\Http\helpers::alltebinfo('contrasts',$description['vest_ocontrast'],'contrsfab_img'))?>" width="24"    alt="<?=$description['vest_ocontrastName']?>" title="<?=$description['vest_ocontrastName']?>"></td>
        </tr>
        <tr><td colspan="4" style="padding-top:0px;padding-left:5px;"><b>Collar Contrast</b></td></tr>
        <tr>
          <td style="vertical-align:middle;padding:5px;">Vest Upper :</td>
          <td style="vertical-align:middle;padding:5px;" width="10%"><?=$vest_ocontlapel?></td>
          <td style="vertical-align:middle;padding:5px;"  width="15%">Pocket Style :</td>
          <td style="vertical-align:middle;padding:5px;" ><?=$vest_ocontpockets?></td>
        </tr>
      </table>
    </td>
    <td></td>
  ...
  <tr> 
    <td colspan="2">
      <table style="background-color: #f1f1f1; font-size:14px; width:50%; text-align:center">
        ...
        <tr>
          <td><?=$description['vest_osizeChest']?></td>
          <td><?=$description['vest_osizeWaist']?></td>
          <td><?=$description['vest_osizeHip']?></td>
          <td><?=$description['vest_osizeShoulder']?></td>
          <td><?=$description['vest_osizeLength']?></td>
        </tr>
      </table>
    </td>
  </tr>
