...
<div class="page-content container-fluid">
    ...
    <!-- ================================ vest data ================================ -->
    <div id="container_vest" class="row tab-container" style="display:none;">
        <div class="col-md-12">
            <div class="panel panel-bordered">
                <div class="panel-body">
                    <?php
                    ...
                    <div class="col-sm-4">
                        <div class="st-img-box">
                            <div class="pt-men-left main-front-etstyle" id="main-front-etstyle">
                                <div class="pt-image-div">
                                    <img src="{{URL::asset('/storage/'.$description['vest_frntviewfinal'])}}"/>
                                </div> 
                                <div class="pt-price-shirt" >
                                    <a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etstyle');">BACK VIEW </a>
                                </div>  
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="st-content-box full-width">
                            <div class="st-box-left">
                                <ul class="st-mf-list">
                                    <li class="st-mf-item"><label>Fabric</label><span>{{$description['vest_ofabricName']}} <figure> <img src="{{URL::asset('/storage/'.$description['vest_ofabricImage'])}}" alt="{{$description['vest_ofabricName']}}" title="{{$description['vest_ofabricName']}}" width="10%"></figure></span></li>
                                    <li class="st-mf-item"><label>Lapel</label><span>{{$description['vest_ostyleName']}}</span></li>
                                    <li class="st-mf-item"><label>Pockets</label><span>{{$description['vest_opacketName']}} </span></li>
                                    <li class="st-mf-item"><label>Bottom</label><span>{{$description['vest_obuttonstyleName']}}</span></li>
                                    <li class="st-mf-item"><label>Back</label><span>{{$description['vest_obackName']}}</span></li>
                                    <li class="st-mf-item"><label>Buttons</label><span>{{$description['vest_obuttonstyleName']}}</span></li>
                                    <li class="st-mf-item"><label>Buton Color</label><span>{{$description['vest_obuttonCode']}} { {{$description['vest_obuttonName']}} }</span></li>
                                    <li class="st-mf-item"><label>Thread Color</label><span>{{$description['vest_obuttonHoleCode']}} {  {{$description['vest_obuttonHoleName']}}  }</span></li>
                                </ul>
                            </div>
                            <div class="st-box-right">
                                <h5>Collar Contrast</h5>
