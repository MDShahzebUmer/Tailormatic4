...
@stop
@section('page_header')
    <h1 class="page-title" style="height:50px;margin-top: 0px;padding-top:14px;padding-left: 60px;"><i class="voyager-data" style="top:18px;left:30px;font-size:20px;"></i> Measurments List:
                             ...
                             <tbody>
                              ...
                              <tr>
                               ...
                               @if($catid==1 || $catid=='')
                                ...
                                @endif
                                @if($catid!=1)
                                <td> @if($d->country_id == 1) European Size @elseif($d->country_id == 2) UK/American Size @else  @endif </td>
                                <td><?php 
								if($d->standardsize_id!=0){
								
								echo $size=App\StandardSize::get_standersizevalue($d->standardsize_id);
