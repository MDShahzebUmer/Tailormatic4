                             ...
                             <div class="panel-body">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="mer_id" id="mer_id" class="form-control select" required>
                                ...
                                <div class="form-group">
                                  <label for="standardsize_id">Country Standardsize No</label>
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="country_id" id="country_id" class="form-control select">
                                    <option value="">Select Country Measurments Size</option>
                            ...
                            {{ csrf_field() }}
                             <div class="panel-body">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label for="country_id">Country Standardsize No</label>
