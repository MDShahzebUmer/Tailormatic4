...
@stop
@section('page_header')
    <h1 class="page-title"><i class="voyager-data"></i>Pant Design</h1>
@stop
@section('content')
<style>
.clhide{ display:none;}
                ...
                <div class="panel panel-bordered">
                	...
                	@endforeach
                        ...
                        <form role="form" action="" method="POST" enctype="multipart/form-data">
							...
							$style = App\AttributeStyle::select('id','style_name')->where('attri_id', '=' , $cuffs)->get(); ?>
                          ...
                          <input type="hidden" name="fab_id" value="{{$designlist->fab_id}}">
                                ...
                                <div class="form-group">
                                    <label for="password">Front Cuffs Pant</label>
                 ...
                 @else
						...
						?>
                            <h3 class="panel-title">Edit "{{$stylename}}" Cuffs</h3>
                        </div>
