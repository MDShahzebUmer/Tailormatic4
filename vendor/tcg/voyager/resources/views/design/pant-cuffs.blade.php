    ...
    <div class="row">
            	...
            	<div class="col-md-5">
                  <h1 class="page-title" style="height:70px;">
                   <i class="voyager-data"></i> Pant "{{$attstyle->style_name}}" Cuffs Image
                   </h1>
                   </div>
...
<div class="col-md-12">
    ...
    <a href="{{ route('voyager.pantcuffs.add') }}/{{$attstyle->id}}" class="btn btn-success">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click">
                                        ...
                                        <a href="{{ route('voyager.pantcuffs.edit') }}/{{$p->id}}" class="btn-sm btn-primary pull-right edit">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('voyager.pantcuffs.delete',$p->id) }}" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
