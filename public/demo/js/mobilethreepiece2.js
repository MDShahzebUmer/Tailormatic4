...
function viewMainBackPant(){ 
	$('#prev_img_pant #main-front').css('display','none');
	$('#prev_img_pant #main-back').css('display','block');
}
function viewMainFrontPant(){ 
	$('#prev_img_pant #main-front').css('display','block');
	$('#prev_img_pant #main-back').css('display','none');
}
///* Tab */
...
function backPantProcessing(){
	...
	fabric.Image.fromURL(_src, function(oImg) {
		...
		$("#prev_img_pant div[id^='main-back']").find("div.pt-pantimage-div img").attr("src",cdata);
...
function frontPantProcessing(){
	...
	fabric.Image.fromURL(_src, function(oImg) {
		...
		if (retpantfrontsrc.length > 0) { 
			...
			$("#prev_img_pant div[id^='main-front']").find("div.pt-pantimage-div img").attr("src",cdata);
...
function showPantMeasureSect(id){
	...
	if(id=="bodysize" || id=="standardsize"){
		...
		if(id=="bodysize"){ 
			...
			var fview=$("#prev_img_pant #main-front").find("div.pt-pantimage-div img").attr("src");
			var bview=$("#prev_img_pant #main-back").find("div.pt-pantimage-div img").attr("src"); 
	...
	if(main_nav_str=="etfabric"){
		...
		switch(stab){
			...
			case "49":
				...
				break;
			case "50":
				openPgContent('menu-49','etstylepant','49','','style');
				break;
			case "51":
				openPgContent('menu-50','etstylepant','50','','style');
				break;
			case "52":
				openPgContent('menu-51','etstylepant','51','','style');
				break;
			case "53":
				openPgContent('menu-52','etstylepant','52','','style');  
				break;
		}
		...
		switch(stab){
			case "54":
				openPgContent('menu-25','etcontrastjacket','25','','contrast');
				break;
		}
	}
}
