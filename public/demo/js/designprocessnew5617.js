var retfrontsrc=[];var retbacksrc=[];var fcanvas = new fabric.StaticCanvas('frontcanvas', {renderOnAddRemove: false});var bcanvas = new fabric.StaticCanvas('backcanvas', {renderOnAddRemove: false});
...
function getfab(id,otab){	
    ...
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
       ...
       success:function(data){ 
			...
			updatefabprice();
			//setTimeout($(".et-small-loader").fadeOut(),10);
	   }
    });
}
