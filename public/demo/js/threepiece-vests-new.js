...
function showMeasureSect(id){
	...
	if(id=="bodysize" || id=="standardsize"){
		...
		if(id=="bodysize"){ 
			...
			var fview=$("#container_vests #main-front-etmeasurement").find("div.pt-image-div img").attr("src"); 
			var bview=$("#container_vests #main-back-etmeasurement").find("div.pt-image-div img").attr("src"); 
	...
	if(main_nav_str=="etfabric"){ 
		...
		switch(stab){
			case "35":
				...
				break;
			case "36":
				var next_sub_menu = document.getElementById("sub_menu_35");
				openPgContent(next_sub_menu,'menu-35','etstyle','35','','style');
				break;
			case "37":
				var next_sub_menu = document.getElementById("sub_menu_36");
				openPgContent(next_sub_menu,'menu-36','etstyle','36','','style');
				break;
			case "38":
				var next_sub_menu = document.getElementById("sub_menu_37");
				openPgContent(next_sub_menu,'menu-37','etstyle','37','','style');
				break;
			case "39":
				var next_sub_menu = document.getElementById("sub_menu_38");
				openPgContent(next_sub_menu,'menu-38','etstyle','38','','style'); 
				break;
		}
