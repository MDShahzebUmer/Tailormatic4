...
function getTabSect(str) {
    ...
    var tabID = "#" + str;
    var otitle = $.trim(str);
    var lis = $(tabID).find('div .pt-variation');
    $.each(lis, function() {
        $(this).removeClass('active');
        $(tabID).find('div .pt-variation div.pt-box-square').removeClass('active');
    });
    $(tabID).addClass('active');
    $(tabID).find('div .pt-variation div:eq(0)').addClass('active');
    ...
    if (otitle == "etfabric") {
        ...
        if (ttle == "35") {
            $("#menuopttitle-" + otitle).html("Choose Your Neck Line :");
        } else if (ttle == "40") {
            $("#menuopttitle-" + otitle).html("Choose Your Contrast Fabric :");
        }
    }
...
function getPgOption(str, tabstr, attrid, attrnm) {
    ...
    if (tabstr == "etfabric") {
        ...
        if (attrid == "4") {
            $("#menuopttitle-" + tabstr).html("Choose Your Sleeve Style :");
        } else if (attrid == "5") {
            $("#menuopttitle-" + tabstr).html("Choose Your Front Style :");
        } else if (attrid == "6") {
            $("#menuopttitle-" + tabstr).html("Choose Your Back Style :");
        } else if (attrid == "7") {
            $("#menuopttitle-" + tabstr).html("Choose Your Bottom Style :");
        } else if (attrid == "8") {
            $("#menuopttitle-" + tabstr).html("Choose Your Collar Style :");
        } else if (attrid == "9") {
            $("#menuopttitle-" + tabstr).html("Choose Your Cuff Style :");
        } else if (attrid == "10") {
            $("#menuopttitle-" + tabstr).html("Choose Your Pocket Style :");
        } else if (attrid == "11") {
            $("#menuopttitle-" + tabstr).html("Choose Your Contrast Fabric :");
        } else if (attrid == "12") {
            $("#menuopttitle-" + tabstr).html("Choose Your Button Color :");
        } else if (attrid == "13") {
            $("#menuopttitle-" + tabstr).html("Choose Your Monogram Position :");
        }
    }
    $("div[id^='miniview-']").css("display", "none");
...
function changeMview(str) {
    $("div[id^='tble_']").css("display", "none");
    $("div#tble_" + str).css("display", "block");
}

function designProcessing() {
    var jArray = document.getElementById("harr").value;
    ...
    switch (jArray['obottom']) {
        case "11":
            ...
            if (jArray['ofront'] == "5") {
                if (jArray['ofrontBoxOut'] == "true") {
                    boxplacket = url + "/Shirts/FabricContrasts/Mix/FrontTriTabPlacket/" + fabcontrastimg;
                } else {
                    boxplacket = url + "/Shirts/Style/Bottom/TriTab/Inner/" + fabimg;
                }
            } else {
                boxplacket = imgNone;
            }
            if (jArray['oback'] == "8") {
                if (jArray['obackBoxOut'] == "true") {
                    boxpleats = url + "/Shirts/FabricContrasts/Mix/BackTriTabPlacket/" + fabcontrastimg;
                } else {
                    boxpleats = url + "/Shirts/Style/Bottom/TriTab/Outer/" + fabimg;
                }
            } else {
                boxpleats = imgNone;
            }
            if (jArray['oseams'] == "true") {
                seams = url + "/Shirts/Style/Front/Seams/Tritab/" + fabimg;
            } else {
                seams = imgNone;
            }
            break;
        case "12":
            ...
            if (jArray['ofront'] == "5") {
                if (jArray['ofrontBoxOut'] == "true") {
                    boxplacket = url + "/Shirts/FabricContrasts/Mix/FrontStraightPlacket/" + fabcontrastimg;
                } else {
                    boxplacket = url + "/Shirts/Style/Bottom/Straight/Inner/" + fabimg;
                }
            } else {
                boxplacket = imgNone;
            }
            if (jArray['oback'] == "8") {
                if (jArray['obackBoxOut'] == "true") {
                    boxpleats = url + "/Shirts/FabricContrasts/Mix/BackStraightPlacket/" + fabcontrastimg;
                } else {
                    boxpleats = url + "/Shirts/Style/Bottom/Straight/Outer/" + fabimg;
                }
            } else {
                boxpleats = imgNone;
            }
            if (jArray['oseams'] == "true") {
                seams = url + "/Shirts/Style/Front/Seams/Straight/" + fabimg;
            } else {
                seams = imgNone;
            }
            break;
        case "13":
            ...
            if (jArray['ofront'] == "5") {
                if (jArray['ofrontBoxOut'] == "true") {
                    ...
                    boxplacket = url + "/Shirts/Style/Bottom/StraightVents/Inner/" + fabimg;
                }
            } else {
                boxplacket = imgNone;
            }
            if (jArray['oback'] == "8") {
                if (jArray['obackBoxOut'] == "true") {
                    ...
                    boxpleats = url + "/Shirts/Style/Bottom/StraightVents/Outer/" + fabimg;
                }
            } else {
                boxpleats = imgNone;
            }
    ...
    if ((jArray['ocollarCuffIn'] == "true" || jArray['ocollarCuffout'] == "true" || jArray['ofrontPlacketIn'] == "true" || jArray['ofrontPlacketOut'] == "true" || jArray['obackBoxOut'] == "true") && jArray['obottom'] == "11") {
        bottomcut = url + "/Shirts/FabricContrasts/Mix/BottomCut/" + fabcontrastimg;
    } else {
        bottomcut = imgNone;
    }
    switch (jArray['osleeve']) {
        case "1":
            ...
            sleevebtn = imgNone;
            if (jArray['ocuff'] == "34" || jArray['ocuff'] == "35" || jArray['ocuff'] == "36") {
                cuffbtn = url + "/Shirts/Style/Cuffs/FrenchRound/Show/" + dbutton;
            } else {
                cuffbtn = imgNone;
            }
            backsleev = url + "/Shirts/Style/Sleeve/LongSleeve/Back/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                cuffout = url + "/Shirts/FabricContrasts/Mix/RightOutCuffLongPattern/" + fabcontrastimg;
            } else {
                cuffout = imgNone;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                cuffin = url + "/Shirts/FabricContrasts/Mix/RightInCuffLongPattern/" + fabcontrastimg;
            } else {
                cuffin = url + "/Shirts/Style/Sleeve/LongSleeve/Outer/" + fabimg;
            }
            if (jArray['ocollarCuffout'] == "true") {
                backcuffout = url + "/Shirts/FabricContrasts/Mix/BackCuff/" + fabcontrastimg;
            } else {
                backcuffout = imgNone;
            }
            break;
        case "2":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                cuffout = url + "/Shirts/FabricContrasts/Mix/RightOutCuffRollPattern/" + fabcontrastimg;
            } else {
                cuffout = imgNone;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                cuffin = url + "/Shirts/FabricContrasts/Mix/RightInCuffRollPattern/" + fabcontrastimg;
            } else {
                cuffin = url + "/Shirts/Style/Sleeve/LongSleeveRollup/Outer/" + fabimg;
            }
            if (jArray['ocollarCuffout'] == "true") {
                backcuffout = url + "/Shirts/FabricContrasts/Mix/BackCuff/" + fabcontrastimg;
            } else {
    ...
    var frontthread = "";
    if (jArray['ofront'] != "6") {
        frontthread = url + "/Shirts/Style/Front/BoxPlacket/Thread/" + jArray['obuttonHoleStyle'] + "Front/" + dthread;
    } else {
        frontthread = imgNone;
    }
    switch (jArray['ocollar']) {
        case "14":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/ItalianCollar1Button/mainRound/" + fabcontrastimg;
            } else {
                collar = url + "/Shirts/Style/Collar/ItalianCollar1Button/Front/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarinner = url + "/Shirts/FabricContrasts/Mix/RightCollerIn/" + fabcontrastimg;
            } else {
                collarinner = imgNone;
            }
            break;
        case "15":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/ItalianCollar2Button/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "16":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/FrenchCollar1Button/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "17":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/FrenchCollar2Button/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "18":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/CutAway1Button/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "19":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/CutAway2Button/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "20":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/RoundCollar/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "21":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/ButtonDown/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "22":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/HiddenButton/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "23":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/Tab/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "24":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/BatmanCollar/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "25":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/ModernCollar/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "26":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/Tuxedo/mainRound/" + fabcontrastimg;
            } else {
        ...
        case "27":
            ...
            if (jArray['ocollarCuffout'] == "true") {
                collar = url + "/Shirts/FabricContrasts/Mix/Collar/Band/mainRound/" + fabcontrastimg;
            } else {
                collar = imgNone;
            }
            if (jArray['ocollarCuffIn'] == "true") {
    ...
    if (jArray['ocollarCuffout'] == "true") {
        backcollr = url + "/Shirts/FabricContrasts/Mix/RightBackColler/" + fabcontrastimg;
    } else {
        backcollr = imgNone;
    }
    switch (jArray['oback']) {
    ...
    if (_src.indexOf('4') == 0) {
        ...
        fabric.Image.fromURL(_src, function(oImg) {
            ...
            if (retfrontsrc.length > 0) {
                ...
                setTimeout($(".et-small-loader").fadeOut(), 3000);
            }
        }, {
...
function designOpenProcessing() {
    ...
    switch (jArray['ocollar']) {
        case "14":
            ...
            collar = url + "/Shirts/Style/Collar/ItalianCollar1Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/ItalianCollar1Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/ItalianCollar1Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
                collarrightin = url + "/Shirts/Fabric/ImageIn/" + fabimg;
            }
        ...
        case "15":
            ...
            collar = url + "/Shirts/Style/Collar/ItalianCollar2Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/ItalianCollar2Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/ItalianCollar2Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "16":
            ...
            collar = url + "/Shirts/Style/Collar/FrenchCollar1Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/FrenchCollar1Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/FrenchCollar1Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "17":
            ...
            collar = url + "/Shirts/Style/Collar/FrenchCollar2Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/FrenchCollar2Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/FrenchCollar2Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "18":
            ...
            collar = url + "/Shirts/Style/Collar/CutAway1Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/CutAway1Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/CutAway1Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "19":
            ...
            collar = url + "/Shirts/Style/Collar/CutAway2Button/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/CutAway2Button/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/CutAway2Button/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "20":
            ...
            collar = url + "/Shirts/Style/Collar/RoundCollar/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/RoundCollar/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/RoundCollar/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "21":
            ...
            collar = url + "/Shirts/Style/Collar/ButtonDown/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/ButtonDown/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/ButtonDown/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "22":
            ...
            collar = url + "/Shirts/Style/Collar/HiddenButton/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/HiddenButton/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/HiddenButton/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "23":
            ...
            collar = url + "/Shirts/Style/Collar/Tab/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/Tab/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/Tab/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "24":
            ...
            collar = url + "/Shirts/Style/Collar/BatmanCollar/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/BatmanCollar/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/BatmanCollar/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "25":
            ...
            collar = url + "/Shirts/Style/Collar/ModernCollar/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/ModernCollar/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/ModernCollar/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "26":
            ...
            collar = url + "/Shirts/Style/Collar/Tuxedo/Front/" + fabimg;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/Tuxedo/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/Tuxedo/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
        ...
        case "27":
            ...
            collar = imgNone;
            if (jArray['ocollarCuffout'] == "true") {
                collarouter = url + "/Shirts/FabricContrasts/Mix/Collar/Band/mainView/" + fabcontrastimg;
            } else {
                collarouter = url + "/Shirts/Style/Collar/Band/Show/" + fabimg;
            }
            if (jArray['ocollarCuffIn'] == "true") {
                collarrightin = url + "/Shirts/FabricContrasts/Mix/OpenCollerin/" + fabcontrastimg;
            } else {
    ...
    if (jArray['ofrontPlacketIn'] == "true") {
        innerplacket = url + "/Shirts/FabricContrasts/Mix/RightFrontIn/" + fabcontrastimg;
    } else {
        innerplacket = imgNone;
    }
    if (jArray['ofrontPlacketOut'] == "true") {
        outerplacket = url + "/Shirts/FabricContrasts/Mix/RightFrontOut/" + fabcontrastimg;
    } else {
        outerplacket = imgNone;
    }
    if (jArray['ocollarCuffout'] == "true") {
        backcollr = url + "/Shirts/FabricContrasts/Mix/RightBackColler/" + fabcontrastimg;
    } else {
...
function getfab(id, otab) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var arr2 = document.getElementById("harr").value;
            arr2 = JSON.parse(arr2);
            var collr = arr2['ocollar'];
            var vw = $("#sview").val();
            if (vw == "open" && (collr != 21 && collr != 22 && collr != 23 && collr != 26 && collr != 27)) {
                designOpenProcessing();
            } else {
                designProcessing();
            }
            updatefabprice();
...
function getseloptions(id, opt, ctyp, otab) {
    ...
    //new added for fix contrast error ----------------------------------
    if(opt == 'Epaulette'){
		if(arr['oshoulder'] == 'true'){
			arr['oshoulder'] = 'false';
		}else{
			arr['oshoulder'] = 'true';
		}
	...
	} else if(opt == 'CollarStay'){
		if(arr['ocollarStay'] == 'true'){
			arr['ocollarStay'] = 'false';
		}else{
			arr['ocollarStay'] = 'true';
		}
	} else if(opt == 'CollarCuffIn'){
		if(arr['ocollarCuffIn'] == 'true'){
			arr['ocollarCuffIn'] = 'false';
		}else{
			arr['ocollarCuffIn'] = 'true';
		}
	} else if(opt == 'CollarCuffOut'){
		if(arr['ocollarCuffout'] == 'true'){
			arr['ocollarCuffout'] = 'false';
		}else{
			arr['ocollarCuffout'] = 'true';
		}
	} else if(opt == 'FrontPlacketIn'){
		if(arr['ofrontPlacketIn'] == 'true'){
			arr['ofrontPlacketIn'] = 'false';
		}else{
			arr['ofrontPlacketIn'] = 'true';
		}
	} else if(opt == 'FrontPlacketOut'){
		if(arr['ofrontPlacketOut'] == 'true'){
			arr['ofrontPlacketOut'] = 'false';
		}else{
			arr['ofrontPlacketOut'] = 'true';
		}
	} else if(opt == 'FrontBoxOut'){
		if(arr['ofrontBoxOut'] == 'true'){
			arr['ofrontBoxOut'] = 'false';
		}else{
			arr['ofrontBoxOut'] = 'true';
		}
	} else if(opt == 'BackBoxOut'){
		if(arr['obackBoxOut'] == 'true'){
			arr['obackBoxOut'] = 'false';
		}else{
			arr['obackBoxOut'] = 'true';
		}
	} else if(opt == 'NumPocket'){
		arr['opacketCount'] = id;
	}
    ...
    var datacont_2 = '';
    datacont_2 += '<img src="'+url+'/Shirts/Fabric/S/'+arr['ofabric']+'.jpg" alt="">';
    datacont_2 += '<img src="'+url+'/Shirts/Threads/'+arr['obuttonHoleStyle']+'/'+arr['obuttonHole']+'.png" alt="" style="padding-left:18px; padding-top:20px;">';
    datacont_2 += '<img src="'+url+'/Shirts/Buttons/'+arr['obutton']+'.png" alt="" style="padding-left:34px; padding-top:36px;">';
    datacont_2 += '<img src="'+url+'/Shirts/Threads/C/'+arr['obuttonHole']+'.png" alt="" style="padding-left:17px; padding-top:18px;">';

    var datacont_3 = '';
    if(arr['omonogram']==1){
        datacont_3 += '<img src="'+url+'/none/none.jpg" alt="'+arr['omonogramName']+'">';
    } else if(arr['omonogram']==46){
        datacont_3 += '<img src="'+url+'/Shirts/ColorContract/Monogram/MonogramOnWaist/List/'+arr['ofabric']+'.jpg" alt="'+arr['omonogramName']+'">';
        datacont_3 += '<span style="color: '+arr['omonogramtextColor']+';position: absolute;top: 0;width: 100%;left: 0;padding: 55px 0px;font-size:12px;font-style:italic;font-family: Mtcorsva;">'+arr['omonogramText']+'</span>';
    } else if(arr['omonogram']==47){
        datacont_3 += '<img src="'+url+'/Shirts/ColorContract/Monogram/MonogramOnChest/List/'+arr['ofabric']+'.jpg" alt="'+arr['omonogramName']+'">';
        datacont_3 += '<span style="color: '+arr['omonogramtextColor']+';position: absolute;top: 0;width: 100%;left: 0;padding: 75px 0px 35px;font-size:12px;font-style:italic;font-family: Mtcorsva;">'+arr['omonogramText']+'</span>';
    } else if(arr['omonogram']==48){
        datacont_3 += '<img src="'+url+'/Shirts/ColorContract/Monogram/MonogramOnPocket/List/'+arr['ofabric']+'.jpg" alt="'+arr['omonogramName']+'">';
        datacont_3 += '<span style="color: '+arr['omonogramtextColor']+';position: absolute;top: 11px;width: 100%;left: 0;font-size:12px;font-style:italic;font-family: Mtcorsva;">'+arr['omonogramText']+'</span>';
    } else if(arr['omonogram']==49){
        datacont_3 += '<img src="'+url+'/Shirts/ColorContract/Monogram/MonogramOnCuff(Right)/List/'+arr['ofabric']+'.jpg" alt="'+arr['omonogramName']+'">';
        datacont_3 += '<span style="color: '+arr['omonogramtextColor']+';position: absolute;top: 55px;width: 100%;left: 0;transform: rotate(65deg);;font-size:12px;font-style:italic;font-family: Mtcorsva;">'+arr['omonogramText']+'</span>';
    }

    $('#miniview-etcontrast-11 .et-selected-img').html(datacont_1);
    $('#miniview-etcontrast-12 .et-selected-img').html(datacont_2);
    $('#miniview-etcontrast-13 .et-selected-img').html(datacont_3);
    // --------------------------------------------------------------------
...
function showMeasureSect(id) {
    ...
    if (id == "bodysize" || id == "standardsize" || id == "outfitsize") {
        ...
        if (id == "bodysize") {
            ...
            $("input#bsizeNeck2").focus();
            $("span#fldtitle2").html("Neck");
            $("span#rngfrom2").html("9");
            $("span#rngto2").html("23");
            $("div.et-measure-image-2").find("figure img").attr("src", url + "/Measurment/Shirts/neck/neck.jpg");
            $("div.et-measure-video-2").html('<video width="100%" loop preload="metadata" autoplay controls class="__web-inspector-hide-shortcut__"><source src="' + url + '/Measurment/Shirts/neck/neck.ogv" type="video/ogg"><source src="' + url + '/Measurment/Shirts/neck/neck.mp4" type="video/mp4"><object data="' + url + '/Measurment/Shirts/neck/neck.swf" type="application/x-shockwave-flash" width="300" height="220"></object><source src="' + url + '/Measurment/Shirts/neck/neck.webm" type="video/webm"></video>');
            var fview = $("#main-front").find("div.pt-image-div img").attr("src");
            var bview = $("#main-back").find("div.pt-image-div img").attr("src");
...
function addMoreSize() {
    ...
    // $("#stdullst").append('<ul class="add_other_size cl' + cl + '"><li><div class="et-btn-group"><div class="et-btn-select">' + sizedv + '</div></div></li><li><span>Quantity :</span></li><li><div class="et-btn-group"><div class="et-btn-select">' + qtydv + '</div></div></li><li><a href="#" onClick="javascript:delQty(\'cl' + cl + '\');"><i class="fa fa-minus-circle" aria-hidden="true"></i></a></li></ul>');
    var size_html = '';
    size_html += '<ul class="cl' + cl + '" style="margin-top:7px;">';
    size_html += '<li class="st-m-sli">';
    size_html += '<span class="st-m-sli-cap">Select Your Size :</span>';
    size_html += '<div class="et-btn-group"><div class="et-btn-select">' + sizedv + '</div></div>';
    size_html += '<a href="#" style="color:red;margin-left:30px;" onClick="javascript:delQty(\'cl' + cl + '\');"><i class="fa fa-minus-circle" aria-hidden="true"></i></a>';
    size_html += '</li>';
    size_html += '<li class="st-m-sli">';
    size_html += '<span class="st-m-sli-cap">Quantity :</span>';
    size_html += '<div class="et-btn-group"><div class="et-btn-select">' + qtydv + '</div></div>';
    
    size_html += '</li>';
    // size_html += '<li><a href="#" onClick="javascript:delQty(\'cl' + cl + '\');"><i class="fa fa-minus-circle" aria-hidden="true"></i></a></li>';
    size_html += '</ul>';
    $("#stdullst").append(size_html);
}
...
function showRanges2(ttl, frange, trange, typ) {
    ...
    var video_html = '';
    video_html += '<video width="100%" loop preload="metadata" autoplay controls class="__web-inspector-hide-shortcut__">';
        video_html += '<source src="' + url + '/Measurment/Shirts/' + typ + '/' + typ + '.ogv" type="video/ogg">';
        video_html += '<source src="' + url + '/Measurment/Shirts/' + typ + '/' + typ + '.mp4" type="video/mp4">';
        video_html += '<object data="' + url + '/Measurment/Shirts/' + typ + '/' + typ + '.swf" type="application/x-shockwave-flash" width="300" height="220">';
        video_html += '</object><source src="' + url + '/Measurment/Shirts/' + typ + '/' + typ + '.webm" type="video/webm">';
    video_html += '</video>';
    $("div.et-measure-video-2").html(video_html);
...
function validatebodyform2() {
    var typ = $("input[id^='bsizetyp2']:checked").attr("value");
    var rnge = "";
    if (document.getElementById('bsizeNeck2').value == "") {
        document.getElementById('bsizeNeck2').focus();
        return false;
    } else if (document.getElementById('bsizeNeck2').value != "") {
        rnge = $("#bsizeNeck2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
        ...
        if (IsFloat(document.getElementById('bsizeNeck2').value) == false) {
            $("#bsizeNeck2").css({
                'border-color': '#f00',
                'box-shadow': '0px 0px 15px #f00',
                '-webkit-box-shadow': '0px 0px 15px #f00'
            ...
            document.getElementById('bsizeNeck2').focus();
            return false;
        } else if (parseFloat(document.getElementById('bsizeNeck2').value) < parseFloat(frange) || parseFloat(document.getElementById('bsizeNeck2').value) > parseFloat(trange)) {
            $("#bsizeNeck2").css({
                'border-color': '#f00',
                'box-shadow': '0px 0px 15px #f00',
                '-webkit-box-shadow': '0px 0px 15px #f00'
    ...
    if (document.getElementById('bsizeChest2').value == "") {
        ...
        rnge = $("#bsizeChest2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
    ...
    if (document.getElementById('bsizeHip2').value == "") {
        document.getElementById('bsizeHip2').focus();
        return false;
    } else if (document.getElementById('bsizeHip2').value != "") {
        rnge = $("#bsizeHip2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
    ...
    if (document.getElementById('bsizeLength2').value == "") {
        ...
        rnge = $("#bsizeLength2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
    ...
    if (document.getElementById('bsizeShoulder2').value == "") {
        document.getElementById('bsizeShoulder2').focus();
        return false;
    } else if (document.getElementById('bsizeShoulder2').value != "") {
        rnge = $("#bsizeShoulder2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
    ...
    if (document.getElementById('bsizeSleeve2').value == "") {
        document.getElementById('bsizeSleeve2').focus();
        return false;
    } else if (document.getElementById('bsizeSleeve2').value != "") {
        rnge = $("#bsizeSleeve2").attr("data-title").split('-');
        frange = parseFloat(rnge[0]);
        trange = parseFloat(rnge[1]);
        if (typ == "cm") {
            frange = Math.round(frange * 2.54, 2);
