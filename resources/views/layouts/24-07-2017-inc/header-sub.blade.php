...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Duniya Tailoe|| {{$seo['meta_title']}}</title>
        <meta name="keywords" content="Duniya Tailoe|| {{$seo['meta_keyword']}}">
        <meta name="description" content="Duniya Tailoe|| {{$seo['meta_desc']}}">
    ...
    <div class="container">
        <div class="row">
            <div id="et-wrapper" class="et-navbar"><!-- Navbar Start -->
                ...
                <!-- Sidebar -->
                @php $seq = Request::segments(); $seq = $seq[0]; @endphp
                @if($seq == 'login')
                <div class="et-icon">
