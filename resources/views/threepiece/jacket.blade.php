            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="etfabricjacket">
                    <div class="pt-variation-main">
                        <div class="pt-variation">
                            ...
                            <div id="menu-fabric{{$gr->id}}" class="pt-box-square <?php if($gr->id == $eJacketTailorObj['ofabricType']) {?>active<?php } ?>" onClick="javascript:getPgJacketOption(this.id,'etfabricjacket','{{$gr->id}}','menu-fabric');">
                                <p>{{$gr->fbgrp_name}}</p>
                                <?php
                                    $frate = 0;
                    ...
                    <div class="pt-customize">
                        <div class="pt-men">
                            <!-- Main Preview -->
                            <div class="pt-men-left" id="main-front-etfabricjacket"><div class="m-image pt-jacketimage-div">@include('jacket.process')<img src="{{asset('demo/img/product/blank.png')}}"/></div><div class="pt-price-shirt"><span class="pt-sht"> Jacket {1 Jacket} </span><br><span class="pt-dollor">${{$eJacketTailorObj['ofabricPrice']}}</span><br><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBackJacket('etfabricjacket');">BACK VIEW</a></div></div>
                            ...
                            <div class="pt-choose-right">
                                <div class="pt-thumb-slider">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <figure class="et-fabric-big"><img src="{{asset('/storage/'.$eJacketTailorObj['ofabricImage'])}}" alt="{{ $eJacketTailorObj['ofabricName'] }}">
                                                        </figure>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Shopping Cart -->
                                    <div class="et-checkout-box">@include('threepiece.shopping')</div>
                                    <!-- End Shopping Cart -->
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane" id="etstylejacket">
                    ...
                    <div class="pt-customize">
                        <div class="pt-men">
                            <!-- Main Preview -->
                            <div class="pt-men-left" id="main-front-etstylejacket"><div class="m-image pt-jacketimage-div">@include('jacket.process')<img src="{{asset('demo/img/product/blank.png')}}"/></div><div class="pt-price-shirt"><span class="pt-sht"> Jacket {1 Jacket} </span><br><span class="pt-dollor">${{$eJacketTailorObj['ofabricPrice']}}</span><br><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBackJacket('etstylejacket');">BACK VIEW</a></div></div>
                ...
                <div role="tabpanel" class="tab-pane contrast-content" id="etcontrastjacket">
                    <div class="pt-variation-main">
                        <div class="pt-variation">
                            ...
                            <div id="menu-{{$contlst->id}}" class="pt-box-square <?php if($contlst->id=='25'){?>active<?php } ?>" onClick="javascript:getPgJacketOption(this.id,'etcontrastjacket','{{$contlst->id}}','{{$contlst->attribute_name}}');" >
                    ...
                    <div class="pt-customize">
                        <div class="pt-men">
                            <!-- Main Preview -->
                            <!-- FRONT VIEW -->
                            <div class="pt-men-left" id="main-front-etcontrastjacket" style="display:none;"><div class="m-image pt-jacketimage-div">@include('jacket.process')<img src="{{asset('demo/img/product/blank.png')}}"/></div><div class="pt-price-shirt"><span class="pt-sht"> Jacket {1 Jacket} </span><br><span class="pt-dollor">${{$eJacketTailorObj['ofabricPrice']}}</span><br><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBackJacket('etcontrastjacket');">BACK VIEW</a></div></div>
                            <!-- SIDE VIEW -->
                            <div class="pt-men-left" id="main-side-etcontrastjacket" style="display:none;"><div class="m-image pt-jacketimage-div">@include('jacket.process')<img src="{{asset('demo/img/product/blank.png')}}"/></div><div class="pt-price-shirt"><span style="color: #eb4301;font-size: 20px;"> Inside View Of Jacket </span></div></div>
                            <!-- BACK VIEW -->
                                ...
                                <div class="pt-thumb-slider">
                                    ...
                                    <div class="et-progress-des et-style-bg">
                                        ...
                                        <div class="et-content-fab jacket-backcollr-bg" id="miniview-etcontrastjacket-27" style="display:none; background-image: url({{asset('demo/img/product/blank.png')}});" >
                                            <figure><img src="{{asset('/storage/Jacket/BackColler/'.$eJacketTailorObj['obackCollar'].'.png')}}" style="position: absolute;top: 0px;left: 137px;"></figure>
                ...
                <div role="tabpanel" class="tab-pane" id="etmeasurementjacket">
                    <div class="pt-variation-main">
                        <div class="pt-variation">
                            ...
                            <div id="menu-jacket-outfitsize" class="pt-box-square" onClick="showJacketMeasureSect2('outfitsize');"><p>Outfit Size</p></div>
                    ...
                    <div class="pt-customize">
                        <div class="pt-men">
                            ...
                            <div id="menu-mesure-jacket-main" style="display:block;">
                                <div class="pt-men-left et-measure-left" id="main-front-etmeasurementjacket"><div class="m-image pt-jacketimage-div"><img src="{{asset('demo/img/product/blank.png')}}"/></div><div class="pt-price-shirt"><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBackJacket('etmeasurementjacket');" >BACK VIEW</a></div></div>
                                    ...
                                    <div class="et-main-measurement">
                                        ...
                                        <div class="et-common-size et-block">
                                            <div class="et-type-Input">
                                                <div class="et-input">
                                                    <span>CHEST</span>
                                                    <p class="et-blue" id="vest_s_vchest"></p>
                                                    <p class="et-tsize">Inch</p>
                                                    <input type="hidden" name="vest_s_sizeChest" id="vest_s_sizechest" value="">
                                                </div>
                                                <div class="et-input">
                                                    <span>WAIST</span>
                                                    <p class="et-blue" id="vest_s_vwaist"></p>
                                                    <p class="et-tsize">Inch</p>
                                                    <input type="hidden" name="vest_s_sizeWaist" id="vest_s_sizewaist" value="">
                                                </div>
                                                <div class="et-input">
                                                    <span>HIP</span>
                                                    <p class="et-blue" id="vest_s_vhip"></p>
                                                    <p class="et-tsize">Inch</p>
                                                    <input type="hidden" name="vest_s_sizeHip" id="vest_s_sizehip" value="">
                                                </div>
                                                <div class="et-input">
                                                    <span>SHOULDERS</span>
                                                    <p class="et-blue" id="vest_s_vshoulder"></p>
                                                    <p class="et-tsize">Inch</p>
                                                    <input type="hidden" name="vest_s_sizeShoulder" id="vest_s_sizeshoulder" value="">
                                                </div>
                                                <div class="et-input">
                                                    <span>LENGTH</span>
                                        ...
                                        <div class="et-block et-form-btn">
                                            ...
                                            <div class="et-btn-group">
                                                <h4 style="color:#f00; font-weight:bold;" class="vwprice">3Piece Suit ( 1 Jacket, 1 Pant , 1 Vest ) : $ {{$first_price}} </h4>
                                            </div>
                                        </div>
                                        </form>
                                    </div>
                                         ...
                                         {{ csrf_field() }}
                                            ...
                                            <div class="et-block no-pad">
                                                ...
                                                <div class="et-subhead">
                                                    ...
                                                    <span>Vest <span id="vest_fldtitle">Chest</span> generally range from <b><span id="vest_rngfrom">28</span></b> to <b><span id="vest_rngto">75</span></b> <span id="vest_mtyp">inch</span></span>
                                                </div>
                                                <div class="et-type-Input">
                                                    <div class="et-input">
                                                        <span>CHEST</span>
                                                        ...
                                                        @foreach($measurechestlst as $mchestlst)
                                                        <input type="text" data-title="{{$mchestlst->from_range}}-{{$mchestlst->to_range}}" name="temp_vest_bsizeChest" id="temp_vest_bsizeChest" onFocus="javascript:showVestRangesTemp('{{$mchestlst->bodysize_type}}',{{$mchestlst->from_range}},{{$mchestlst->to_range}},'chest');" onBlur="javascript:validateVestFieldTemp(this.id,{{$mchestlst->from_range}},{{$mchestlst->to_range}});" value="<?php echo $eTailorObj['osizeChest'];?>" style="border-color:#f00;">
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>WAIST</span>
                                                        ...
                                                        @foreach($measurewaistlst as $mwaistlst)
                                                        <input type="text" data-title="{{$mwaistlst->from_range}}-{{$mwaistlst->to_range}}" name="temp_vest_bsizeWaist" id="temp_vest_bsizeWaist" onFocus="javascript:showVestRangesTemp('{{$mwaistlst->bodysize_type}}',{{$mwaistlst->from_range}},{{$mwaistlst->to_range}},'waist');" onBlur="javascript:validateVestFieldTemp(this.id,{{$mwaistlst->from_range}},{{$mwaistlst->to_range}});" value="<?php echo $eTailorObj['osizeWaist'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>HIP</span>
                                                        ...
                                                        @foreach($measurehiplst as $mhiplst)
                                                        <input type="text" data-title="{{$mhiplst->from_range}}-{{$mhiplst->to_range}}" name="temp_vest_bsizeHip" id="temp_vest_bsizeHip" onFocus="javascript:showVestRangesTemp('{{$mhiplst->bodysize_type}}',{{$mhiplst->from_range}},{{$mhiplst->to_range}},'hip');" onBlur="javascript:validateVestFieldTemp(this.id,{{$mhiplst->from_range}},{{$mhiplst->to_range}});" value="<?php echo $eTailorObj['osizeHip'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>SHOULDER</span>
                                                        ...
                                                        @foreach($measureshoulderlst as $mshoulderlst)
                                                        <input type="text" data-title="{{$mshoulderlst->from_range}}-{{$mshoulderlst->to_range}}" name="temp_vest_bsizeShoulder" id="temp_vest_bsizeShoulder" onFocus="javascript:showVestRangesTemp('{{$mshoulderlst->bodysize_type}}',{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}},'shoulder');" onBlur="javascript:validateVestFieldTemp(this.id,{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}});" value="<?php echo $eTailorObj['osizeShoulder'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>LENGTH</span>
                                                        ...
                                                        @foreach($measurelengthlst as $mlengthlst)
                                                        <input type="text" data-title="{{$mlengthlst->from_range}}-{{$mlengthlst->to_range}}" name="temp_vest_bsizeLength" id="temp_vest_bsizeLength" onFocus="javascript:showVestRangesTemp('{{$mlengthlst->bodysize_type}}',{{$mlengthlst->from_range}},{{$mlengthlst->to_range}},'length');" onBlur="javascript:validateVestFieldTemp(this.id,{{$mlengthlst->from_range}},{{$mlengthlst->to_range}});" value="<?php echo $eTailorObj['osizeLength'];?>" >
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <!-- ====================================================================== -->
                            ...
                            <!-- BODY SIZES END -->
                            <!-- ============================== OUTFIT SIZES ====================================== -->
                            <div class="pt-choose-right et-main-body-size" id="menu-mesure-jacket-outfitsize" style="display:none;">
                                <div class="pt-thumb-slider">
                                    <div class="et-des-title"><h2>YOUR OUTFIT SIZES</h2></div>
                                    <div class="et-main-measurement">
                                            <div class="et-block">
                                                <div class="et-measure-image-2">
                                                    <figure><img src="{{asset('/storage/Measurment/Shirts/chest/chest.jpg')}}" alt=""></figure>
                                                </div>
                                                <div class="et-measure-video-2">
                                                    <video width="100%" loop preload="metadata" autoplay controls class="__web-inspector-hide-shortcut__"><source src="{{asset('/storage/Measurment/Shirts/chest/chest.ogv')}}" type="video/ogg"><source src="{{asset('/storage/Measurment/Shirts/chest/chest.mp4')}}" type="video/mp4"><object data="{{asset('/storage/Measurment/Shirts/chest/chest.swf')}}" type="application/x-shockwave-flash" width="300" height="220"></object><source src="{{asset('/storage/Measurment/Shirts/chest/chest.webm')}}" type="video/webm"></video>
                                                </div>
                                            </div>
                                            <div class="et-block no-pad">
                                                    ...
                                                    <div class="et-setect-fit">
                                                        <ul>
                                                            ...
                                                            <li style="width:75px;">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="bsizetyp" id="bsizetyp2" value="cm" <?php if($eJacketTailorObj['osizeType']=="cm"){?>checked<?php } ?>>
                                                                        <span class="cr"><i class="cr-icon"></i></span>Cm
                                                                    </label>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <div class="radio">
                                                                    <label><input type="radio" name="bsizetyp" id="bsizetyp2" value="inch" <?php if($eJacketTailorObj['osizeType']=="inch"){?>checked<?php } ?> ><span class="cr"><i class="cr-icon"></i></span>Inch</label>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="et-subhead">
                                                    <span class="longarrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                                                    <span>Jacket <span id="fldtitle2">Chest</span> generally range from <b><span id="rngfrom2">28</span></b> to <b><span id="rngto2">75</span></b> <span id="mtyp2">inch</span></span>
                                                </div>
                                                <div class="et-type-Input">
                                                    <div class="et-input">
                                                        <span>CHEST</span>
                                                        <?php $measurechestlst = App\MeasurmentVideo::select('*')->where('id','=',33)->get();?>
                                                        @foreach($measurechestlst as $mchestlst)
                                                        <input type="text" data-title="{{$mchestlst->from_range}}-{{$mchestlst->to_range}}" name="bsizeChest" id="bsizeChest2" onFocus="javascript:showJacketRanges2('{{$mchestlst->bodysize_type}}',{{$mchestlst->from_range}},{{$mchestlst->to_range}},'chest');" onBlur="javascript:validateJacketField2(this.id,{{$mchestlst->from_range}},{{$mchestlst->to_range}});" value="<?php echo $eJacketTailorObj['osizeChest'];?>" style="border-color:#f00;">
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>WAIST</span>
                                                        <?php $measurewaistlst = App\MeasurmentVideo::select('*')->where('id','=',34)->get();?>
                                                        @foreach($measurewaistlst as $mwaistlst)
                                                        <input type="text" data-title="{{$mwaistlst->from_range}}-{{$mwaistlst->to_range}}" name="bsizeWaist" id="bsizeWaist2" onFocus="javascript:showJacketRanges2('{{$mwaistlst->bodysize_type}}',{{$mwaistlst->from_range}},{{$mwaistlst->to_range}},'waist');" onBlur="javascript:validateJacketField2(this.id,{{$mwaistlst->from_range}},{{$mwaistlst->to_range}});" value="<?php echo $eJacketTailorObj['osizeWaist'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>HIP</span>
                                                        <?php $measurehiplst = App\MeasurmentVideo::select('*')->where('id','=',35)->get();?>
                                                        @foreach($measurehiplst as $mhiplst)
                                                        <input type="text" data-title="{{$mhiplst->from_range}}-{{$mhiplst->to_range}}" name="bsizeHip" id="bsizeHip2" onFocus="javascript:showJacketRanges2('{{$mhiplst->bodysize_type}}',{{$mhiplst->from_range}},{{$mhiplst->to_range}},'hip');" onBlur="javascript:validateJacketField2(this.id,{{$mhiplst->from_range}},{{$mhiplst->to_range}});" value="<?php echo $eJacketTailorObj['osizeHip'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>SHOULDER</span>
                                                        <?php $measureshoulderlst = App\MeasurmentVideo::select('*')->where('id','=',36)->get();?>
                                                        @foreach($measureshoulderlst as $mshoulderlst)
                                                        <input type="text" data-title="{{$mshoulderlst->from_range}}-{{$mshoulderlst->to_range}}" name="bsizeShoulder" id="bsizeShoulder2" onFocus="javascript:showJacketRanges2('{{$mshoulderlst->bodysize_type}}',{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}},'shoulder');" onBlur="javascript:validateJacketField2(this.id,{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}});" value="<?php echo $eJacketTailorObj['osizeShoulder'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>SLEEVE</span>
                                                        <?php $measuresleevelst = App\MeasurmentVideo::select('*')->where('id','=',37)->get();?>
                                                        @foreach($measuresleevelst as $msleevlst)
                                                        <input type="text" data-title="{{$msleevlst->from_range}}-{{$msleevlst->to_range}}" name="bsizeSleeve" id="bsizeSleeve2" onFocus="javascript:showJacketRanges2('{{$msleevlst->bodysize_type}}',{{$msleevlst->from_range}},{{$msleevlst->to_range}},'sleeve');" onBlur="javascript:validateJacketField2(this.id,{{$msleevlst->from_range}},{{$msleevlst->to_range}});" value="<?php echo $eJacketTailorObj['osizeSleeve'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>LENGTH</span>
                                                        <?php $measurelengthlst = App\MeasurmentVideo::select('*')->where('id','=',38)->get();?>
                                                        @foreach($measurelengthlst as $mlengthlst)
                                                        <input type="text" data-title="{{$mlengthlst->from_range}}-{{$mlengthlst->to_range}}" name="bsizeLength" id="bsizeLength2" onFocus="javascript:showJacketRanges2('{{$mlengthlst->bodysize_type}}',{{$mlengthlst->from_range}},{{$mlengthlst->to_range}},'length');" onBlur="javascript:validateJacketField2(this.id,{{$mlengthlst->from_range}},{{$mlengthlst->to_range}});" value="<?php echo $eJacketTailorObj['osizeLength'];?>" >
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <!-- =============================== for pant ============================= -->
                                                <div class="et-subhead">
                                                    <span class="longarrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>
                                                    <span>Pant <span id="pant_fldtitle2">Waist</span> generally range from <b><span id="pant_rngfrom2">28</span></b> to <b><span id="pant_rngto2">75</span></b> <span id="pant_mtyp2">inch</span></span>
                                                </div>
                                                <div class="et-type-Input">
                                                    <div class="et-input">
                                                        <span>WAIST</span>
                                                        ...
                                                        @foreach($measurewaistlst as $mwaistlst)
                                                        <input type="text" data-title="{{$mwaistlst->from_range}}-{{$mwaistlst->to_range}}" name="temp_pant_bsizeWaist" id="temp_pant_bsizeWaist2" onFocus="javascript:showPantRangesTemp2('{{$mwaistlst->bodysize_type}}',{{$mwaistlst->from_range}},{{$mwaistlst->to_range}},'waist');" onBlur="javascript:validatePantFieldTemp2(this.id,{{$mwaistlst->from_range}},{{$mwaistlst->to_range}});" value="<?php echo $ePantTailorObj['osizeWaist'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>HIP</span>
                                                        ...
                                                        @foreach($measurehiplst as $mhiplst)
                                                        <input type="text" data-title="{{$mhiplst->from_range}}-{{$mhiplst->to_range}}" name="temp_pant_bsizeHip" id="temp_pant_bsizeHip2" onFocus="javascript:showPantRangesTemp2('{{$mhiplst->bodysize_type}}',{{$mhiplst->from_range}},{{$mhiplst->to_range}},'hip');" onBlur="javascript:validatePantFieldTemp2(this.id,{{$mhiplst->from_range}},{{$mhiplst->to_range}});" value="<?php echo $ePantTailorObj['osizeHip'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>CROTCH</span>
                                                        ...
                                                        @foreach($measurecrotchlst as $mcrotchlst)
                                                        <input type="text" data-title="{{$mcrotchlst->from_range}}-{{$mcrotchlst->to_range}}" name="temp_pant_bsizeCrotch" id="temp_pant_bsizeCrotch2" onFocus="javascript:showPantRangesTemp2('{{$mcrotchlst->bodysize_type}}',{{$mcrotchlst->from_range}},{{$mcrotchlst->to_range}},'croch');" onBlur="javascript:validatePantFieldTemp2(this.id,{{$mcrotchlst->from_range}},{{$mcrotchlst->to_range}});" value="<?php echo $ePantTailorObj['osizeCrotch'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>THIGH</span>
                                                        ...
                                                        @foreach($measurethighlst as $mthighlst)
                                                        <input type="text" data-title="{{$mthighlst->from_range}}-{{$mthighlst->to_range}}" name="temp_pant_bsizeThigh" id="temp_pant_bsizeThigh2" onFocus="javascript:showPantRangesTemp2('{{$mthighlst->bodysize_type}}',{{$mthighlst->from_range}},{{$mthighlst->to_range}},'thigh');" onBlur="javascript:validatePantFieldTemp2(this.id,{{$mthighlst->from_range}},{{$mthighlst->to_range}});" value="<?php echo $ePantTailorObj['osizeThigh'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>LENGTH</span>
                                                        ...
                                                        @foreach($measurelengthlst as $mlengthlst)
                                                        <input type="text" data-title="{{$mlengthlst->from_range}}-{{$mlengthlst->to_range}}" name="temp_pant_bsizeLength" id="temp_pant_bsizeLength2" onFocus="javascript:showPantRangesTemp2('{{$mlengthlst->bodysize_type}}',{{$mlengthlst->from_range}},{{$mlengthlst->to_range}},'length');" onBlur="javascript:validatePantFieldTemp2(this.id,{{$mlengthlst->from_range}},{{$mlengthlst->to_range}});" value="<?php echo $ePantTailorObj['osizeLength'];?>" >
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <!-- =============================== for vest ============================= -->
                                                <div class="et-subhead">
                                                    ...
                                                    <span>Vest <span id="vest_fldtitle2">Chest</span> generally range from <b><span id="vest_rngfrom2">28</span></b> to <b><span id="vest_rngto2">75</span></b> <span id="vest_mtyp2">inch</span></span>
                                                </div>
                                                <div class="et-type-Input">
                                                    <div class="et-input">
                                                        <span>CHEST</span>
                                                        <?php $measurechestlst = App\MeasurmentVideo::select('*')->where('id','=',39)->get();?>
                                                        @foreach($measurechestlst as $mchestlst)
                                                        <input type="text" data-title="{{$mchestlst->from_range}}-{{$mchestlst->to_range}}" name="temp_vest_bsizeChest" id="temp_vest_bsizeChest2" onFocus="javascript:showVestRangesTemp2('{{$mchestlst->bodysize_type}}',{{$mchestlst->from_range}},{{$mchestlst->to_range}},'chest');" onBlur="javascript:validateVestFieldTemp2(this.id,{{$mchestlst->from_range}},{{$mchestlst->to_range}});" value="<?php echo $eTailorObj['osizeChest'];?>" style="border-color:#f00;">
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>WAIST</span>
                                                        <?php $measurewaistlst = App\MeasurmentVideo::select('*')->where('id','=',40)->get();?>
                                                        @foreach($measurewaistlst as $mwaistlst)
                                                        <input type="text" data-title="{{$mwaistlst->from_range}}-{{$mwaistlst->to_range}}" name="temp_vest_bsizeWaist" id="temp_vest_bsizeWaist2" onFocus="javascript:showVestRangesTemp2('{{$mwaistlst->bodysize_type}}',{{$mwaistlst->from_range}},{{$mwaistlst->to_range}},'waist');" onBlur="javascript:validateVestFieldTemp2(this.id,{{$mwaistlst->from_range}},{{$mwaistlst->to_range}});" value="<?php echo $eTailorObj['osizeWaist'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>HIP</span>
                                                        <?php $measurehiplst = App\MeasurmentVideo::select('*')->where('id','=',41)->get();?>
                                                        @foreach($measurehiplst as $mhiplst)
                                                        <input type="text" data-title="{{$mhiplst->from_range}}-{{$mhiplst->to_range}}" name="temp_vest_bsizeHip" id="temp_vest_bsizeHip2" onFocus="javascript:showVestRangesTemp2('{{$mhiplst->bodysize_type}}',{{$mhiplst->from_range}},{{$mhiplst->to_range}},'hip');" onBlur="javascript:validateVestFieldTemp2(this.id,{{$mhiplst->from_range}},{{$mhiplst->to_range}});" value="<?php echo $eTailorObj['osizeHip'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>SHOULDER</span>
                                                        <?php $measureshoulderlst = App\MeasurmentVideo::select('*')->where('id','=',42)->get();?>
                                                        @foreach($measureshoulderlst as $mshoulderlst)
                                                        <input type="text" data-title="{{$mshoulderlst->from_range}}-{{$mshoulderlst->to_range}}" name="temp_vest_bsizeShoulder" id="temp_vest_bsizeShoulder2" onFocus="javascript:showVestRangesTemp2('{{$mshoulderlst->bodysize_type}}',{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}},'shoulder');" onBlur="javascript:validateVestFieldTemp2(this.id,{{$mshoulderlst->from_range}},{{$mshoulderlst->to_range}});" value="<?php echo $eTailorObj['osizeShoulder'];?>" >
                                                        @endforeach
                                                    </div>
                                                    <div class="et-input">
                                                        <span>LENGTH</span>
                                                        <?php $measurelengthlst = App\MeasurmentVideo::select('*')->where('id','=',43)->get();?>
                                                        @foreach($measurelengthlst as $mlengthlst)
                                                        <input type="text" data-title="{{$mlengthlst->from_range}}-{{$mlengthlst->to_range}}" name="temp_vest_bsizeLength" id="temp_vest_bsizeLength2" onFocus="javascript:showVestRangesTemp2('{{$mlengthlst->bodysize_type}}',{{$mlengthlst->from_range}},{{$mlengthlst->to_range}},'length');" onBlur="javascript:validateVestFieldTemp2(this.id,{{$mlengthlst->from_range}},{{$mlengthlst->to_range}});" value="<?php echo $eTailorObj['osizeLength'];?>" >
                                                        @endforeach
                                                    </div>
                                                </div>
                                                <!-- ====================================================================== -->
                                                <div class="et-block">
                                                    <div class="et-setect-fit">
                                                        <ul>
                                                            <li><span class="longarrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span><span>Select Your Size :</span></li>
                                                            <li><div class="radio"><label><input type="radio" name="fitstyle" id="fitstyle2" value="Comfortable" <?php if($eJacketTailorObj['osizeStyle']=="Comfortable"){?> checked<?php }?> ><span class="cr"><i class="cr-icon"></i></span>Signature Standard Fit</label></div></li>
                                                            <li><div class="radio"><label><input type="radio" name="fitstyle" id="fitstyle2" value="Slim" <?php if($eJacketTailorObj['osizeStyle']=="Slim"){?> checked<?php }?> ><span class="cr"><i class="cr-icon"></i></span>Euro Slim Fit</label></div></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <!-- ================= new added for body type ===================== -->
                                                ...
                                                <input type="hidden" name="selbodyqty" value="1" id="bselbodyqty2">
                                                <input type="hidden" name="tocken" id="tocken2" value="{{csrf_token() }}">
                                                <input type="hidden" name="rndvalue" id="brndvalue2" value="<?php echo rand(100000, 999999);?>">
                                                <div id="et-body"  class="et-cart-brn" style="display:none; width:80px"><img src="{{URL::asset('asset/img/page-loader.gif')}}"></div>
                                                    <!-- <button type="sumbit" class="et-cart-brn" id="jacket_body_cart_btn" style="display:none;">Add To Cart</button> -->
                                                    <button class="et-cart-brn" id="temp_body_btn2">Add To Cart</button>
                                                    <div class="et-btn-group">
                                                        <h4 style="color:#f00; font-weight:bold;" class="vwprice">3Piece Suit ( 1 Jacket, 1 Pant , 1 Vest ) : ${{$first_price}} </h4>
                                                    </div>
                                                </div>
