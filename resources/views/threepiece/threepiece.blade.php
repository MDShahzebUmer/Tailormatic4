...
<!-- CSS 
============================================ -->
<link rel="stylesheet" type="text/css" href="{{asset('demo/css/stylethreepiece.css?')}}?v<?=rand(1, 1000000)?>" media="all">
...
<script type="text/javascript" src="{{asset('demo/js/threepieceprocessnew.js')}}?v<?=rand(1, 1000000)?>"></script>
<script type="text/javascript" src="{{asset('demo/js/threepiece-pants-new.js')}}?v<?=rand(1, 1000000)?>"></script>
<script type="text/javascript" src="{{asset('demo/js/threepiece-vests-new.js')}}?v<?=rand(1, 1000000)?>"></script>
