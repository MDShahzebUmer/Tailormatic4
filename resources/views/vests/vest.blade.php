                            		...
                            		<div class="pt-men">
                                        ...
                                        <div class="pt-choose-right et-main-body-size" id="menu-mesure-bodysize" style="display:none;">
                                     		<div class="pt-thumb-slider">
                                                ...
                                                <div class="et-main-measurement">
                                                	<form class="et-shirt-measure" role="form" method="POST" action="{{ url('/designvests/postcart') }}" onsubmit="return validatebodyform();">
                                                     {{ csrf_field() }}
                                                    	<div class="et-block">
                                                        	<div class="et-measure-image">
                                                            	<figure>
...
<script type="text/javascript" src="{{asset('demo/js/vestsprocessnew.js')}}?v<?=rand(1, 1000000)?>"></script>
