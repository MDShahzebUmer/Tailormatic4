...
<div id="tailor_content" class="tailor-content" style="display:none;">
    ...
    <div id="tab-content" class="c-tab-content tab-content" style="display:none;">
        ...
        <div class="threepiece-content">
            @include('twopiece.mobile1')
            @include('twopiece.mobile2')
        </div>
    </div>
    <!-- =================================== tab menu ===================================== -->
...
<script type="text/javascript" src="{{asset('demo/js/mobiletwopiece1.js')}}?v<?=rand(1, 1000000)?>"></script>
<script type="text/javascript" src="{{asset('demo/js/mobiletwopiece2.js')}}?v<?=rand(1, 1000000)?>"></script>
