    ...
    <div class="pt-design">  
        ...
        <div class="container">
            <?php
                ...
                $first_price = ($fabric_ary[0]['jacket']->fabric_rate + $fabric_ary[0]['pant']->fabric_rate);
            ?>
            <div class="row custom-main-content mb75">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="total-price-div">
                                <p>
                                    <span class="fn-skyblue" data-lang="suit3pcs">2Piece Suit</span></br>
                                    <span class="span-jack">{ 1 <l data-lang="jacket">Jacket</l>, 1 <l data-lang="pant">Pant</l> } </span></br>
                                    <span id="twopiece_total" class="price fn-red">${{number_format($first_price,2)}}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 custom-right-content">
                    ...
                    <div class="threepiece-content">
                        @include('twopiece.jacket')
                        @include('twopiece.pants')
                    </div>                
                    <!-- TABS ENDS -->
                </div>
            </div>
...
function showStyle(style_type) { //jacket, pant 
    $(".sub-menu-etstyle ul").hide().animate({ opacity: "0" }, 50 );
    $(".m-style-"+style_type).show().animate({ opacity: "1" }, 50 );
