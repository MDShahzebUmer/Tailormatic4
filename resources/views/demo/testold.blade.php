  	...
  	<div class="pt-design">  
        ...
        <div class="container">
            <div class="pt-customer">
                <p class="bd-pt">DESIGN</p><p>CUSTOMIZER</p>
            </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="etmeasurement">
                            	...
                            	<div class="pt-customize">
                            		<div class="pt-men">
                                        ...
                                        <div class="pt-men-left et-measure-left" id="main-front-etmeasurement"><div class="pt-image-div"><img src="{{asset('demo/img/product/pt-shirts.png')}}" alt=""/></div><div class="pt-price-shirt"><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etmeasurement');" >BACK VIEW</a></div></div>
                                        ...
                                        <div class="pt-choose-right et-main-body-size" id="menu-mesure-standardsize" style="display:none;">             
                                     		<div class="pt-thumb-slider">
                                            	<div class="et-des-title"><h2 style="margin-right: 345px;">Size Chart</h2></div>
                                                <div class="et-main-measurement">
                                                	<form class="et-shirt-measure" role="form" method="POST" action="{{ url('/designshirts/postcart') }}">
                                                    	{{ csrf_field() }}
                                                        <div class="et-block no-pad">
                                                            <div class="et-block">
                                                            	<div class="et-setect-fit">
                                                                	<ul><li><span class="longarrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></li><li><div class="radio"><label><input type="radio" name="sizetyp" value="cm" <?php if($eTailorObj['osizeType']=="cm"){?>checked<?php } ?> onClick="javascript:changeMview(this.value)"><span class="cr"><i class="cr-icon"></i></span>Cm</label></div></li><li><div class="radio"><label><input type="radio" name="sizetyp" value="inch" <?php if($eTailorObj['osizeType']=="inch"){?>checked<?php } ?> onClick="javascript:changeMview(this.value)"><span class="cr"><i class="cr-icon"></i></span>Inch</label></div></li></ul>
                                                                </div>
                                                            </div>
                                                                	...
                                                                	<ul>
                                                                    	...
                                                                    	<li><div class="et-btn-group">
                                                                                <div class="et-btn-select" id="dvsizeoption">
                                                                                    ...
                                                                                    <select class="selectpicker btn-primary" id="selsize" name="selsize[]">
                                                                        ...
                                                                        <li>
                                                                        	<div class="et-btn-group">
                                                                                <div class="et-btn-select" id="dvqtyoption">
                                                                                    <select class="selectpicker btn-primary" id="selstdqty" name="selstdqty[]">
                                                                                    	@for($i=1;$i<=100;$i++)
                                                            ...
                                                            <div class="et-block et-form-btn">
                                                                ...
                                                                <input type="hidden" name="mpattern" value="Standard"><button type="sumbit" class="et-cart-brn">Add To Cart</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                        ...
                                        <div class="pt-choose-right et-main-body-size" id="menu-mesure-bodysize" style="display:none;">                  
                                     		<div class="pt-thumb-slider">
                                                ...
                                                <div class="et-main-measurement">
                                                	<form class="et-shirt-measure" role="form" method="POST" action="{{ url('/designshirts/postcart') }}" onSubmit="javascript:return validatebodyform();">
                                                     {{ csrf_field() }}
                                                    	<div class="et-block">
                                                        ...
                                                        <div class="et-block no-pad">
                                                            ...
                                                            <div class="et-block et-form-btn">
                                                                ...
                                                                <input type="hidden" name="frntviewfinal" id="frntviewfinal">
                                                                <input type="hidden" name="bkviewfinal" id="bkviewfinal">
                                                                <input type="hidden" name="mpattern" value="Body"><button type="sumbit" class="et-cart-brn">Add To Cart</button>
                                                                <div class="et-btn-group">
                                                                	@if($eTailorObj['ocartID']=="")
                                                                	<span>Quantity :</span>
...
$(document).ready(function(e){var stid="menu-"+$('#tabSActiveId').val();var stab=$('#tabSActiveId').val(); var newarr=$('#harr').val(); getTabSect($('#tabActiveId').val());getPgOption(stid,$('#tabActiveId').val(),$('#tabSActiveId').val(),''); designProcessing(JSON.parse(newarr));});
</script>
<script type="text/javascript">
