<?php  $seo = App\Http\Helpers::page_seo_details(13);?>
<!doctype html>

<!-- THIS IS THE ACTIVE PAGE OF DESIGN SHIRTS -->
...
$(document).ready(function() {var l=$("#loadme").val();if(l==0){setTimeout(function(){$("#depreload .wrapper").animate({ opacity: 1 });}, 40);setTimeout(function(){$("#depreload .logo").animate({ opacity: 1 });}, 600);var canvas  = $("#depreload .line")[0],context = canvas.getContext("2d");context.beginPath();context.arc(280, 280, 260, Math.PI * 1.5, Math.PI * 1.6);context.strokeStyle = '#9e792b';context.lineWidth = 5;context.stroke();var loader = $("html").DEPreLoad({OnStep: function(percent) {console.log(percent + '%');$("#depreload .line").animate({ opacity: 1 });$("#depreload .perc").text(percent + "%");if (percent > 5) {context.clearRect(0, 0, canvas.width, canvas.height);context.beginPath();context.arc(280, 280, 260, Math.PI * 1.5, Math.PI * (1.5 + percent / 50), false);context.stroke();}},OnComplete: function() {console.log('Everything loaded!'); $("#depreload").hide(100);$("#depreload .perc").text("done");$("#depreload .loading").animate({ opacity: 0 });}});}});
    ...
    <script>
     ...
     //  $(document).ready(function(){
        ...
        var shoulder = '';
        var sleev = '';
        var submitCheck = function(i,val){
            ...
            if(i == 'lentgh') lentgh = i ;

            if(i == 'shoulder') shoulder = i ;

            if(i == 'sleev') sleev = i ;
            var doo = false;
            if(neck) if(chest) if(wasit) if(hip) if(lentgh) if(shoulder) if(sleev) doo = true;
            
            if(doo) $('button[id="add_to_cart_by_input"]').css('display','block');
            else $('button[id="add_to_cart_by_input"]').css('display','none');
            return 0 ;
  	...
  	<div class="pt-design">  
        ...
        <div class="container">
            <!-- <div class="pt-customer"> 
                <p class="bd-pt">Tailormatic</p><p>CUSTOMIZER</p>
            </div> -->
                        ...
                        <div class="tab-content">
                                ...
                                <div class="pt-variation-main">
                                    <div class="pt-variation">
                                    	@foreach($group_record as $gr)
                                      	<div id="menu-fabric{{$gr->id}}" class="pt-box-square <?php if($gr->id == $eTailorObj['ofabricType']) {?>active<?php } ?>" onClick="javascript:getPgOption(this.id,'etfabric','menu-fabric','');">
                                            <p>{{$gr->fbgrp_name}}</p>
                                    ...
                                    <div class="pt-men">
                                        ...
                                        <div class="pt-choose-right">                                     
                                            <div class="pt-thumb-slider">
                                                ...
                                                <div class="et-progress-des" id="preview-etfabric">
                                                    <div class="et-content-fab">
                                                        ...
                                                        <div class="et-fab-box">
                                                            <h2>{{$eTailorObj['ofabricName']}}</h2>
                                                            @if($eTailorObj['ofabric']==1)
                                                            <h1 class="un-bg">WORLD’S BEST</h1><span>100% Cotton</span><div class="et-guarantee"><span>${{number_format($eTailorObj['ofabricPrice'],2)}}</span><figure class="gura-icon"><img src="{{asset('demo/img/sil.png')}}" alt=""></figure></div>
                                                            <h1>SUPER-SOFT</h1><span>80/2X80/2</span>
                                                            @else
                                                            <span>100% Cotton</span><span>easy care</span><h1><h2>&nbsp;</h2><span>-Free Contrast Fabrics</span><span>-Free Monogram/Initials</span>
                                                            @endif
                                                    ...
                                                    <div class="modal fade et-fabric-modal" id="fabric-id" tabindex="-1" role="dialog" aria-labelledby="fabric-modal">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"><figure class="et-fabric-big"><img src="{{asset('/storage/'.$eTailorObj['ofabricImage'])}}" alt="{{ $eTailorObj['ofabricName'] }}"></figure>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- Shopping Cart -->
                                                <div class="et-checkout-box">@include('demo.shopping')</div>
                                                <!-- End Shopping Cart -->
                                            </div>
                                        </div>
                                	</div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="etstyle">
                            	...
                            	<div class="pt-customize">
                            		<div class="pt-men">
                                    	<!-- Main Preview -->
                            			<div class="pt-men-left" id="main-front-etstyle"><div class="pt-image-div">@include('demo.process')<img src="{{asset('demo/img/product/pt-shirts.png')}}"/></div><div class="pt-price-shirt"><span class="pt-sht"> Shirt {1 Shirt} </span><br><span class="pt-dollor">${{number_format($eTailorObj['ofabricPrice'],2)}}</span><br><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etstyle');">BACK VIEW</a></div><div class="pt-bottom-thumb"><ul><li><a href="javascript:designProcessing();"><img src="{{asset('demo/img/product/view-normal.png')}}"></a></li><?php if($eTailorObj['ocollar']!=21 && $eTailorObj['ocollar']!=22 && $eTailorObj['ocollar']!=23 && $eTailorObj['ocollar']!=26 && $eTailorObj['ocollar']!=27){?><li><a href="javascript:designOpenProcessing();"><img src="{{asset('demo/img/product/view-advanced.png')}}"/></a></li><?php } ?></ul><a href="{{url('/')}}/advance3D" class="et-threed-pro" >3D PRO<span>Advanced Designing</span></a></div></div>
                                            ...
                                            <div class="pt-thumb-slider">
                                                            ...
                                                            <div class="item active">
                                                                <ul class="et-item-list">
                                                                    ...
                                                                    <li class="et-item" id="optionlist-{{$mattr->id}}-{{$styllst->id}}" data-title="{{$styllst->style_name}}" title="{{$styllst->style_name}}" onClick="javascript:getstyles({{$styllst->id}},'{{$mattr->id}}','etstyle');">
                                                                        ...
                                                                        @if($styllst->id == 37)
                                                                            <figure class="et-item-img"><img src="{{asset('/storage/none/none.jpg')}}" alt="{{$styllst->style_name}}"></figure>
                                                                            @if($styllst->id == $eTailorObj['opacket'])<div class="icon-check"></div>@endif
                                                                        @else
                                                                            @foreach($styleimglst as $ls)
                                                                            <figure class="et-item-img"><img src="{{asset('/storage/'.$ls->list_img)}}" alt="{{$ls->style_name}}">
                                                                            ...
                                                                            @if($mattr->id!='5')<img src="{{asset('/storage/'.$thrdls->thrd_list_img)}}" alt="{{$ls->style_name}}">@endif
                                                                            @endforeach
                                                                            ...
                                                                            @if($mattr->id!='4')<img src="{{asset('/storage/'.$buttls->button_list_img)}}" alt="{{$ls->style_name}}">@endif
                                                                            @endforeach
                                                                            </figure>
                                                                            @if($mattr->id==4)
                                                ...
                                                <div class="et-progress-des et-style-bg">
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etstyle-5" style="display:none">
                                                    	<figure class="et-selected-img et-selected-full"><img src="{{asset('demo/img/product/pt-shirts.png')}}" alt="{{$eTailorObj['ofrontName']}}"></figure>
                                                        <div class="et-style-select">
                                                            <h2>Front Style</h2>
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etstyle-8" style="display:none">
                                                    	<figure class="et-selected-img">
                                                        	<img src="{{asset('/storage/Shirts/Style/Collar/ItalianCollar1Button/List/1.png')}}" alt="{{$eTailorObj['ocollarName']}}">
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etstyle-9" style="display:none">
                                                    	<figure class="et-selected-img">
                                                        	<img src="{{asset('/storage/Shirts/Style/Cuffs/1ButtonRound/List/1.png')}}" alt="{{$eTailorObj['ocuffName']}}">
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etstyle-10" style="display:none;">
                                                    	<figure class="et-selected-img">
                                                        	<img src="{{asset('/storage/none/none.jpg')}}" alt="{{$eTailorObj['opacketName']}}">
                                                        </figure>
                                                        <div class="et-style-select">
                                                            <h2>Pocket Style</h2>
                            ...
                            <div role="tabpanel" class="tab-pane" id="etcontrast">
                            	...
                            	<div class="pt-customize">
                            		<div class="pt-men">
                                    	<!-- Main Preview -->
                            			<div class="pt-men-left" id="main-front-etcontrast"><div class="pt-image-div">@include('demo.process')<img src="{{asset('demo/img/product/pt-shirts.png')}}"/></div><div class="pt-price-shirt"><span class="pt-sht"> Shirt {1 Shirt} </span><br><span class="pt-dollor">${{number_format($eTailorObj['ofabricPrice'],2)}}</span><br><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etcontrast');">BACK VIEW</a></div><div class="pt-bottom-thumb"><ul><li><a href="javascript:designProcessing();"><img src="{{asset('demo/img/product/view-normal.png')}}"></a></li><?php if($eTailorObj['ocollar']!=21 && $eTailorObj['ocollar']!=22 && $eTailorObj['ocollar']!=23 && $eTailorObj['ocollar']!=26 && $eTailorObj['ocollar']!=27){?><li><a href="javascript:designOpenProcessing();"><img src="{{asset('demo/img/product/view-advanced.png')}}"/></a></li><?php } ?></ul><a href="{{url('/')}}/advance3D" class="et-threed-pro" >3D PRO<span>Advanced Designing</span></a></div></div>
                                			...
                                			<div class="pt-thumb-slider">
                                                                ...
                                                                <ul class="et-item-list">
                                                                    ...
                                                                    @if($cmonolst->id==46)
                                                                        ...
                                                                        <li class="et-item" id="optionlist-{{$contlst->id}}-{{$cmonolst->id}}" data-title="{{$cmonolst->style_name}}" onClick="javascript:getmonogram({{$cmonolst->id}},'etcontrast');">
                                                                            <figure class="et-item-img"><img src="{{asset('/storage/'.$cmonols->list_img)}}" alt="{{$cmonolst->style_name}}" title="{{$cmonolst->style_name}}">
                                    			...
                                    			<div class="et-progress-des et-style-bg">
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etcontrast-12" style="display:none;" >
                                                    	<figure class="et-selected-img">
                                                        <img src="{{asset('storage/Shirts/Fabric/S/'.$eTailorObj['ofabric'].'.jpg')}}" alt="">
                                                        <img src="{{asset('storage/Shirts/Threads/'.$eTailorObj['obuttonHoleStyle'].'/'.$eTailorObj['obuttonHole'].'.png')}}" alt="" style="padding-left:18px; padding-top:20px;">
                                                        <img src="{{asset('storage/Shirts/Buttons/'.$eTailorObj['obutton'].'.png')}}" alt="" style="padding-left:34px; padding-top:36px;"><img src="{{asset('storage/Shirts/Threads/C/'.$eTailorObj['obuttonHole'].'.png')}}" alt="" style="padding-left:17px; padding-top:18px;"></figure>
                                                        <div class="et-style-select">
                                                    ...
                                                    <div class="et-content-fab" id="miniview-etcontrast-13" style="display:none;" >
                                                        <figure class="et-selected-img">
                                                        	...
                                                        	<img src="{{asset('/storage/none/none.jpg')}}" alt="{{$eTailorObj['omonogramName']}}">
                                                            @elseif($eTailorObj['omonogram']==46)
                                                            <img src="{{asset('/storage/Shirts/ColorContract/Monogram/MonogramOnWaist/List/'.$eTailorObj['ofabric'].'.jpg')}}" alt="{{$eTailorObj['omonogramName']}}">
                                                            ...
                                                            <img src="{{asset('/storage/Shirts/ColorContract/Monogram/MonogramOnChest/List/'.$eTailorObj['ofabric'].'.jpg')}}" alt="{{$eTailorObj['omonogramName']}}">
                                                            ...
                                                            <img src="{{asset('/storage/Shirts/ColorContract/Monogram/MonogramOnPocket/List/'.$eTailorObj['ofabric'].'.jpg')}}" alt="{{$eTailorObj['omonogramName']}}">
                                                            ...
                                                            <img src="{{asset('/storage/Shirts/ColorContract/Monogram/MonogramOnCuff(Right)/List/'.$eTailorObj['ofabric'].'.jpg')}}" alt="{{$eTailorObj['omonogramName']}}">
                            ...
                            <div role="tabpanel" class="tab-pane" id="etmeasurement">
                            	...
                            	<div class="pt-customize">
                            		<div class="pt-men">
                                        ...
                                        <div class="pt-men-left et-measure-left" id="main-front-etmeasurement"><div class="pt-image-div"><img src="{{asset('demo/img/product/pt-shirts.png')}}" width="340" height="417" alt=""/></div><div class="pt-price-shirt"><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etmeasurement');" >BACK VIEW</a></div></div>
                                        <div class="pt-men-left et-measure-left" id="main-back-etmeasurement" style="display:none;"><div class="pt-image-div"><img src="{{asset('demo/img/product/pt-shirts-back.png')}}"  width="340" height="417" alt=""/></div><div class="pt-price-shirt"><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainFront('etmeasurement');" >FRONT VIEW</a></div></div>
                                        <!-- End Main Preview -->
                                        <!-- Right Option Section -->
                                                        ...
                                                        <div class="et-block no-pad">
                                                            <div class="et-block">
                                                            	<div class="et-setect-fit">
                                                                	<ul><li><span class="longarrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></li><li><div class="radio"><label><input type="radio" name="sizetyp" id="sizetyp" class="sizetyp" value="cm" <?php if($eTailorObj['osizeType']=="cm"){?>checked<?php } ?> onClick="javascript:changeMview(this.value)"><span class="cr"><i class="cr-icon"></i></span>Cm</label></div></li><li><div class="radio"><label><input type="radio" name="sizetyp" class="sizetyp" id="sizetyp" value="inch" <?php if($eTailorObj['osizeType']=="inch"){?>checked<?php } ?> onClick="javascript:changeMview(this.value)"><span class="cr"><i class="cr-icon"></i></span>Inch</label></div></li></ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="et-block no-pad">
                                                            ...
                                                            <div class="et-block et-form-btn">
                                                               ...
                                                               <input type="hidden" name="frntviewfinal" id="frntviewfinal" class="bfrntviewfinal">
                                                                ...
                                                                <button style="display:none;" type="sumbit" class="et-cart-brn" id="add_to_cart_by_input">Add To Cart</button>
...
<script type="text/javascript" src="{{asset('demo/js/designprocessnew.js')}}"></script>
<!-- Bootstrap Side Menu JS File -->
<script language="javascript" type="text/javascript">
$(document).ready(function(e){var stid="menu-"+$('#tabSActiveId').val();var stab=$('#tabSActiveId').val(); var newarr=$('#harr').val(); getTabSect($('#tabActiveId').val());getPgOption(stid,$('#tabActiveId').val(),$('#tabSActiveId').val(),''); designOpenProcessing(JSON.parse(newarr));});
</script>
<script type="text/javascript">
