...
<!-- CSS
============================================ -->
<link rel="stylesheet" type="text/css" href="{{asset('demo/css/style.css')}}?v<?=rand(1, 1000000)?>" media="all">
    ...
    <script>
     ...
     //  $(document).ready(function(){
        ...
        var submitCheck = function(i,val){
            ...
            if(doo) $('button[id="body"]').css('display','block');
            else $('button[id="body"]').css('display','none');
            return 0 ;
        }
        ...
        var shoulder2 = '';
        var sleev2 = '';
        var submitCheck2 = function(i,val){
            if(i == 'neck') neck2 = i ;
            if(i == 'chest') chest2 = i ;
            if(i == 'wasit') wasit2 = i ;
            if(i == 'hip') hip2 = i ;
            if(i == 'lentgh') lentgh2 = i ;
            if(i == 'shoulder') shoulder2 = i ;
            if(i == 'sleev') sleev2 = i ;
            var doo = false;
            if(neck2) if(chest2) if(wasit2) if(hip2) if(lentgh2) if(shoulder2) if(sleev2) doo = true;
            if(doo) $('button[id="body2"]').css('display','block');
            else $('button[id="body2"]').css('display','none');
            return 0 ;
        }
                                                    ...
                                                    <div class="modal fade et-fabric-modal" id="fabric-id" tabindex="-1" role="dialog" aria-labelledby="fabric-modal">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body"><figure class="et-fabric-big"><img src="{{asset('/storage/'.$eTailorObj['ofabricImage'])}}" alt="{{$alt_name}}"></figure>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="item active">
                                                                <ul class="et-item-list">
                                                                    ...
                                                                    <li class="et-item" id="optionlist-{{$mattr->id}}-{{$styllst->id}}" data-title="{{$styllst->style_name}}" title="{{$styllst->style_name}}" onClick="javascript:getstyles({{$styllst->id}},'{{$mattr->id}}','etstyle');">
                                                                        ...
                                                                        @if($styllst->id == 37)
                                                                            <figure class="et-item-img"><img src="{{asset('/storage/none/none.jpg')}}" alt="{{$alt_name}}"></figure>
                                                                            @if($styllst->id == $eTailorObj['opacket'])<div class="icon-check"></div>@endif
                                                                        @else
                                                                            @foreach($styleimglst as $ls)
                                                                            <figure class="et-item-img"><img src="{{asset('/storage/'.$ls->list_img)}}" alt="{{$alt_name}}">
                            	...
                            	<div class="pt-customize">
                            		<div class="pt-men">
                                        ...
                                        <div id="menu-mesure-main" style="display:block;">
                                            <div class="pt-men-left et-measure-left" id="main-front-etmeasurement"><div class="pt-image-div"><img src="{{asset('demo/img/product/pt-shirts.png')}}" width="340" height="417" alt="{{$alt_name}}"/></div><div class="pt-price-shirt"><a href="javascript:void(0);" class="pt-back-btn" onClick="javascript:viewMainBack('etmeasurement');" >BACK VIEW</a></div></div>
                                                ...
                                                <div class="et-main-measurement">
                                                        ...
                                                        <div class="et-block no-pad">
                                                            ...
                                                            <div class="et-block et-form-btn">
                                                                ...
                                                                <button style="display:none;" type="sumbit" class="et-cart-brn" id="body">Add To Cart</button>
                                                    ...
                                                    <div class="et-block no-pad">
                                                        ...
                                                        <div class="et-type-Input">
                                                            ...
                                                            <div class="et-input">
                                                                ...
                                                                @foreach($measurehiplst as $mhiplst)
                                                                <input onkeyup="submitCheck2('hip',this.value);" type="text" data-title="{{$mhiplst->from_range}}-{{$mhiplst->to_range}}" name="bsizeHip2" id="bsizeHip2" onFocus="javascript:showRanges2('{{$mhiplst->bodysize_type}}',{{$mhiplst->from_range}},{{$mhiplst->to_range}},'hip');" onBlur="javascript:validateField2(this.id,{{$mhiplst->from_range}},{{$mhiplst->to_range}});" value="<?php echo $eTailorObj['osizeHip'];?>" >
                                                                @endforeach
                                                            </div>
                                                            <div class="et-input">
                                                                <span>LENGTH</span>
                                                        ...
                                                        <div class="et-block et-form-btn">
                                                            ...
                                                            <input type="hidden" name="rndvalue" id="brndvalue2" value="<?php echo rand(100000, 999999);?>">
                                                              <div id="et-body"  class="et-cart-brn" style="display:none; width:80px"><img src="{{URL::asset('asset/img/page-loader.gif')}}"></div>
                                                            <button style="display:none;" type="button" class="et-cart-brn" id="body2">Add To Cart</button>
...
<script type="text/javascript" src="{{asset('demo/js/designprocessnew.js')}}?v<?=rand(1, 1000000)?>"></script>
