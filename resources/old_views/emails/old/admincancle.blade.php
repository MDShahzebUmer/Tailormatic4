   ...
   <table cellpadding="0" cellspacing="0" style="{{ $style['table-wrap'] }}">
        ...
        <tbody>
          <tr class="orderId">
            ...
            <tr class="orderId">
              <td colspan="4">
                <h4 style="{{ $style['fisrt-title'] }}">Purchased by {{$u['name']}} ({{$u['email']}}) on Date,
 {{$u['odate']}} has requestd to Cancel Order No.#{{$u['order_id']}}</h4>
            ...
            <tr class="orderId">
              ...
              <h4>Message From {{$u['name']}}</h4>
              <p><b>Reason</b>:{{$u['reason']}}<br>{{$u['decs_reason']}} </p>
              </td>
            </tr>
            ...
            <tr>
                <td colspan="4" style="{{$style['first-head']}}"> <p style="{{ $style['font-italic'] }}"><strong>Regards,</strong><br>EtailorClothes.com</p></td></tr>
            </tr>
