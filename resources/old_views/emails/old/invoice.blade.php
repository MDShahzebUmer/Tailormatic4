...
$style = [
    ...
    'footer-td-wrap' => 'padding: 8px; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd; font-style: italic;background: #593A2E; font-size: 15px; letter-spacing: 1px; color: #fff; font-family: "Proxima Nova Regular";',
...
<body style="{{ $style['body'] }}">
	<table cellpadding="0" cellspacing="0" style="{{ $style['table-body'] }}">
	    <thead>
	      <tr>
	        <td colspan="6" style="{{ $style['invoice-header'] }}"><a href="{{url('/')}}"><img style="{{ $style['logo-img'] }}" src="{{asset('asset/img/email_logo.png')}}"></a></td>
	      </tr>
	    </thead>
	    <tbody>
	        <tr>
