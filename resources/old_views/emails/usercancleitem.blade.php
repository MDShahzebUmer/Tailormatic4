        ...
        <tbody>
          <tr class="orderId">
            <td colspan="4" style="{{$style['first-heads']}}">
              <h2 style="{{ $style['fisrt-title'] }}">Dear {{$u['uname']}}, </h2>
              <br>
            </td>
          </tr>
            ...
            <tr class="orderId">
              <td colspan="4">
                <h4 style="{{ $style['fisrt-title'] }}">We would like to inform you that we have processed your cancellation request for the following items Order #{{$u['order_id']}}</h4>
