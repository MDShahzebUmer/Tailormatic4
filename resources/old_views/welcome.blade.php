                           ...
                           <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="et-client-block">
                                    <div class="et-client-image">
                                        <img src="{{asset('/storage/')}}/{{$t->image}}" alt="eTailor Testimonial" />
                                    </div>
                                    <div class="et-client-caption">
                                        <h5>{{$t->name}}</h5>
                                        <p>{{$t->content}}</p>
                                        <ul>
                                            <li><img src="{{asset('/storage/')}}/{{$t->country_flag}}" alt="eTailor flag"></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="et-grid-style Collectionsec">
               ...
               <div class="box-top"> 
                <div class="col-md-12">
                     <?php $i3 = App\Http\Helpers::img_font_call(3); ?>
                    <div class="et-effect et-landscape">
                         <img src="{{asset('/storage'.$i3->img)}}" alt="eTailor"/>
                        <a href="{{Url('/'.$i3->url)}}">
                            <figcaption>
                                <h2>{!! $i3->title_one !!}</h2>
                                <p>
