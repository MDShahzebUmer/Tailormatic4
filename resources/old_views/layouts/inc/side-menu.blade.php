                    ...
                    <div class="tab-pane" id="tab3">
                        <div id="et-replace" class="et-nav-content" style="background-image:url({{asset('/asset/img/et-dummy-bg-03.jpg')}});">
                            <ul>
                                ...
                                <li>
                                    <a href="{{URL('/designjackets')}}"><span>Collection JACKETS</span></a>
                                </li>
                                <li>
                                    <a href="{{URL('/designvests')}}"><span>Collection Vests</span></a>
                                </li>
                                <li>
                                    <a href="{{URL('/designpants')}}/"><span>Collection Pants</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
