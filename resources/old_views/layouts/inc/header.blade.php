...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://ogp.me/ns/fb#">
    <head>
        ...
        <title>Duniya Tailor - Leading Custom Tailor in USA </title>
        <!--yeh title me tha isko niche kar diya by Shahzeb : || {{$seo['meta_title']}}-->
                ...
                <div class="et-logo">
                    <figure class="top-logo">
                       ...
                       @if(setting('site.logo'))
                        <a href="{{url('/')}}"><img src="{{asset('storage/')}}/{!! setting('site.logo') !!}" alt="Duniya Tailor Logo"></a>
                        @endif
                    </figure>
                </div>
                <!-- Sidebar -->
