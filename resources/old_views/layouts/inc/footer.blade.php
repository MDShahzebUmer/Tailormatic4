        ...
        <div class="row">
            ...
            <div class="et-visa-sec">
               ...
               <div class="right-pay-area">
                ...
                <ul>
                  <li><img src="{{asset('/asset/img/icon-01.jpg')}}"/></li>
                  <li><img src="{{asset('/asset/img/icon-02.jpg')}}"/></li>
                  <li><img src="{{asset('/asset/img/icon-03.jpg')}}"/></li>
                  <li><img src="{{asset('/asset/img/icon-05.jpg')}}"/></li>
                  <li><img src="{{asset('/asset/img/icon-06.jpg')}}"/></li>
                </ul>
...
<div class="mc-field-group">
	...
	<input type="email" value="" name="EMAIL" class="eet-sub-email required email " id="mce-EMAIL">
</div>
            ...
            <div class="col-md-3 col-sm-3">
             ...
             <h2>Why Duniya Tailor</h2>
               <ul>
                 ...
                 <li><a href="{{url('/designjackets')}}">Collection Jackets</a></li>
                 <li><a href="{{url('/designvests')}}">Collection Vests</a></li>
                 <li><a href="{{url('/designpants')}}">Collection Pants</a></li>
