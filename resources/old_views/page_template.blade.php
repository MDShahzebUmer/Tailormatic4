        	...
        	<div class="et-block">
            	<div class="col-md-5 col-xs-12">
                	<figure class="et-full-image">
                    	<img src="{{asset('/asset/img/about-us.png')}}" alt="Duniya Tailor about">
                    </figure>
                </div>
            	...
            	<div class="et-feature">
                	<ul class="featured-img-list">
                        ...
                        <li>
                            <div class="inner">
                                <div class="img">
                                    <img src="{{url('storage/')}}/{{$op->image}}" alt="Duniya Tailor" />
                                </div>
                                <div class="content">
                                    <p>{!! $op->content !!}</p>
    ...
    <div class="container">
        <div class="row">
            <div class="et-sub-title et-fw">
                <h2>Contact Us</h2>
                <p>As part of our commitment to excellent service, we answer all emails within 24-48 hours. However, emails may be undelivered due to various technical reasons. We kindly request you to recontact us, if your query has not been answered within 48 hours.
</p>
            </div>
                ...
                <div class="et-form">
                    <div class="col-md-6 col-xs-12 {{ $errors->has('con_subject') ? ' has-error' : '' }}">
                       <span class="input input--hoshi">
                            ...
                            <input class="input__field input__field--hoshi" type="text" id="any" list="SubjectOptions" placeholder="Subject*" name="con_subject" required>
                            <datalist id="SubjectOptions">
    <option value="General Inquiry">
    <option value="Delivery and Order Tracking">
    <option value="Address Change">
    <option value="Add-on or Modification">
