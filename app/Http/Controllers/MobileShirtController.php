...
class MobileShirtController extends Controller
{
    /**
    ...
    public function index()
    {
		...
		if($device!='MOBILE'){
			return redirect(route('designshirts'));
		}       		
		...
		return view::make('demo/mobileshirt')->with(compact('car_record','group_record','mainattr_record','contrast_record','eTailorObj','mytab','mysubtab','loadme'));
    }
   ...
   public function getfabdetails()
   {
        ...
        if($eTailorObjN['ofabric']==1){
        	$data=$data.'<h1 class="un-bg">WORLD’S BEST</h1><span>100% Cotton</span><div class="et-guarantee"><span>'.number_format($frate,2).'$</span><figure class="gura-icon"><img src="'.$p[0].'/demo/img/sil.png" alt=""></figure></div><h1>SUPER-SOFT</h1><span>80/2X80/2</span>';
		} else {
		...
		$datatab=$datatab.'</ul>';
		/*<a href="'.$p[0].'/advance3D" class="et-threed-pro" >3D PRO<span>Advanced Designing</span></a>*/
		/* Contrast */
